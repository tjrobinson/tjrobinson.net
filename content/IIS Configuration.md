...
There is lots more information about the various settings here:

- [Security `<security>` configuration reference — Microsoft Learn](http://www.iis.net/ConfigReference/system.webServer/security)
...
- [Configuring remote administration and feature delegation in IIS 7 — learn.iis.net (no longer online)](http://learn.iis.net/page.aspx/159/configuring-remote-administration-and-feature-delegation-in-iis-7/)
