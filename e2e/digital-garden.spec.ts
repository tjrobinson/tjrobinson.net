...
test.describe("Digital Garden (Quartz)", () => {
  test.describe("Index page", () => {
    ...
    test("loads with correct page title", async ({ page }) => {
      await expect(page.locator(".article-title")).toContainText("Welcome to my Digital Garden")
    })
  ...
  test.describe("Content pages", () => {
    ...
    test("backlinks section renders when page has incoming links", async ({ page }) => {
